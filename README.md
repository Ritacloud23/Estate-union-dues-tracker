...
- [CHAIRMAN ADE'S MONEY BOOK](#chairman-ades-money-book)
  - [Estate Union Dues Tracker](#estate-union-dues-tracker)
- [Table of Contents](#table-of-contents)
- [1. Project Overview](#1-project-overview)
- [2. The Client's Problem](#2-the-clients-problem)
    - [Problems with the old system](#problems-with-the-old-system)
...
- [5. Engineering Requirements](#5-engineering-requirements)
  - [Requirement 1 — The Application Must Be a Package](#requirement-1--the-application-must-be-a-package)
  - [Requirement 2 — `main.py` Must Be Outside the Package](#requirement-2--mainpy-must-be-outside-the-package)
  - [Requirement 3 — Data Must Survive a Restart](#requirement-3--data-must-survive-a-restart)
  - [Requirement 4 — First Run Must Not Crash](#requirement-4--first-run-must-not-crash)
  - [Requirement 5 — The Diary Must Grow](#requirement-5--the-diary-must-grow)
  - [Requirement 6 — Corrupted Data Must Be Handled](#requirement-6--corrupted-data-must-be-handled)
  - [Requirement 7 — README](#requirement-7--readme)
...
- [9. `main.py`](#9-mainpy)
    - [Why `main.py` Does Not Contain Everything](#why-mainpy-does-not-contain-everything)
- [10. `__init__.py`](#10-__init__py)
...
- [16. First-Run Handling](#16-first-run-handling)
- [17. Corrupted Data Handling](#17-corrupted-data-handling)
- [18. The Activity Diary](#18-the-activity-diary)
- [19. Why the Diary Uses Append Mode](#19-why-the-diary-uses-append-mode)
- [20. Why the Diary Is a Plain Text File](#20-why-the-diary-is-a-plain-text-file)
...
- [28. Python Import Styles](#28-python-import-styles)
  - [Import Style 1 — Import Specific Functions](#import-style-1--import-specific-functions)
    - [Why use this style?](#why-use-this-style)
  - [Import Style 2 — Import a Module](#import-style-2--import-a-module)
    - [Why use this style?](#why-use-this-style-1)
- [29. Why Dictionaries and Lists Were Used](#29-why-dictionaries-and-lists-were-used)
- [30. Why JSON Was Used](#30-why-json-was-used)
    - [Advantages of JSON](#advantages-of-json)
...
- [38. Menu Features](#38-menu-features)
    - [Option 1 — Register Member](#option-1--register-member)
    - [Option 2 — View Members](#option-2--view-members)
    - [Option 3 — Record Payment](#option-3--record-payment)
    - [Option 4 — Payment History](#option-4--payment-history)
    - [Option 5 — Payment Status](#option-5--payment-status)
    - [Option 6 — Exit](#option-6--exit)
...
- [43. Project Impact](#43-project-impact)
  - [Reduced Risk of Data Loss](#reduced-risk-of-data-loss)
  - [Better Accountability](#better-accountability)
  - [Easier Identification of Debtors](#easier-identification-of-debtors)
  - [Better Financial History](#better-financial-history)
